        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="p-8 max-w-7xl mx-auto pb-32">
            ...
            <div className="grid lg:grid-cols-12 gap-10">
                <div className="lg:col-span-8">
                    <form onSubmit={handleRegister} className="card-premium p-10 bg-white border-2 border-gray-100 shadow-3xl shadow-gray-200/50 relative overflow-hidden group">
                ...
                <div className="lg:col-span-4">
                    <div className="sticky top-24 space-y-8">
                        ...
                        <div className="card-premium p-10 bg-[#064E3B] text-white flex flex-col items-center justify-center text-center relative overflow-hidden h-[600px] shadow-4xl shadow-emerald-900/40 border-0">
                            <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent pointer-events-none"></div>
                            
                            <AnimatePresence mode="wait">
                                {success ? (
                                    <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} key="success" className="relative z-10 w-full flex flex-col items-center">
                                        ...
                                        <div className="p-8 bg-white rounded-[40px] shadow-2xl flex flex-col items-center relative group">
                                            <div className="absolute -inset-2 bg-emerald-500 rounded-[48px] opacity-20 blur-xl group-hover:opacity-40 transition-opacity"></div>
                                            {qrUrl ? (
                                                <img src={qrUrl} alt="Patient QR Code" className="w-48 h-48 object-cover rounded-[32px] relative z-10" />
                                            ) : (
                                                <div className="w-48 h-48 bg-gray-50 rounded-[32px] flex items-center justify-center relative z-10">
                                                    <QrCode size={80} className="text-gray-200 animate-pulse" />
                                                </div>
                                            )}
                                            <div className="absolute bottom-4 inset-x-0 text-center relative z-10">
                                                <span className="text-[10px] font-black text-emerald-900 uppercase tracking-[0.3em] font-['Montserrat']">Active E-Card</span>
                                            </div>
                                        </div>
                                    ...
                                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} key="waiting" className="relative z-10 opacity-40 flex flex-col items-center">
                        ...
                        {/* Tip Panel */}
                        <div className="card-premium p-8 bg-white border border-gray-100 flex items-start gap-5 shadow-xl shadow-gray-200/50 group hover:-translate-y-1 transition-transform">
